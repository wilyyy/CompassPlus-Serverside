...
require_once('../model/saved_locations.php');
//GetMovies();
//exit;
...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
  require_once("../controller/get/saved_locations.php");
}

//if you send a new movie name over under the variable movie_name, then I will add a new move to the database
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  require_once("../controller/post/saved_locations.php");
}

if($_SERVER['REQUEST_METHOD'] == 'PATCH'){
  require_once("../controller/patch/saved_locations.php");
}

if($_SERVER['REQUEST_METHOD'] == 'DELETE'){
  require_once("../controller/delete/saved_locations.php");
}
?>